...
export const Instructions = () => {
  const instructions = (
    <p>
      ...
      <ul>
        <li>
          Assurez-vous que vos adresses ont été géocodées. Si ce n'est pas le cas,
          utilisez d'abord le widget géocodeur pour remplir les colonnes de latitude
          et longitude.
        </li>
        <li>
        ...
        <li>
          Lancez l'analyse en cliquant sur "Analyser les coordonnées" et constatez
          les résultats. Attention : si aucune de vos adresses ne se trouve dans un 
          QPV, les colonnes resteront vides.
        </li>
        <li>
